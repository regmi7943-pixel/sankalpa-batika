...
export function replyEmailTemplate({ name, originalMessage, replyContent }: { name: string; originalMessage: string; replyContent: string }) {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Response to your inquiry - Sankalpa Vatika School</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; line-height: 1.6;">
    <table role="presentation" style="width: 100%; border-collapse: collapse;">
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 32px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 700;">Sankalpa Vatika School</h1>
                            <p style="margin: 8px 0 0 0; color: #bfdbfe; font-size: 14px;">Official Response</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px;">
                            <p style="margin: 0 0 16px 0; color: #1f2937; font-size: 16px;">Dear ${name},</p>
                            <p style="margin: 0 0 24px 0; color: #4b5563; font-size: 16px; line-height: 1.7;">${replyContent}</p>
                            
                            <hr style="border: 0; border-top: 1px solid #e5e7eb; margin: 32px 0;">
                            
                            <p style="margin: 0 0 12px 0; color: #9ca3af; font-size: 12px; font-weight: 600; text-transform: uppercase;">Regarding your message:</p>
                            <div style="background-color: #f9fafb; border-left: 4px solid #3b82f6; padding: 16px; border-radius: 4px;">
                                <p style="margin: 0; color: #6b7280; font-size: 14px; font-style: italic;">"${originalMessage}"</p>
                            </div>
                            
                            <p style="margin: 32px 0 0 0; color: #1f2937; font-size: 16px;">Best Regards,<br><strong>Sankalpa Vatika Administration</strong></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 24px 32px; border-top: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 0 0 8px 0; color: #9ca3af; font-size: 12px; text-align: center;">Excellence in Education</p>
                            <p style="margin: 0; color: #9ca3af; font-size: 11px; text-align: center;">
                                This is an automated response to your inquiry.<br>
                                © 2024 Sankalpa Vatika School. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
