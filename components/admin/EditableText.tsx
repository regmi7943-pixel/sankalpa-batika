...
export function EditableText({
    ...
    return (
        ...
        >
            ...
            <span className="absolute -top-3 -left-3 bg-blue-500 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-all scale-50 group-hover:scale-100 shadow-md">
