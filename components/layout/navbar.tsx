    ...
    const navLinks = [
        ...
        },
        {
            ...
            subLinks: [
                ...
                { href: '/admissions/inquiry', label: 'Admission Inquiry Form' },
        ...
        { href: '/notices-events', label: 'Notices & Events' },
        {
            ...
            subLinks: [
                ...
                { href: '/clubs/eca-cca', label: 'ECA & CCA' },
                { href: '/clubs/stem-robotics', label: 'STEM & Robotics' },
                { href: '/clubs/book-review', label: 'Book Review Program' },
                { href: '/clubs/fine-arts', label: 'Fine Arts & Music' },
