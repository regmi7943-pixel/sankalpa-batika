    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50">
            ...
            <nav className={`transition-all duration-300 ${isScrolled
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <Link href="/" className="flex items-center gap-3 group">
                            ...
                            <div>
                                ...
                                <p className={`text-xs transition-colors ${isScrolled ? 'text-gray-500' : 'text-blue-100'
                                    }`}>
                ...
                {/* Mobile Menu */}
                <div className={`lg:hidden transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-screen bg-white shadow-xl' : 'max-h-0'
                    }`}>
