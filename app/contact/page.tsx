...
export default async function ContactPage() {
    ...
    return (
        <div className="pt-20">
            ...
            {/* Contact Cards */}
            <section className="py-12 md:py-16 bg-gray-50 -mt-10 md:-mt-16 relative z-10">
                            ...
                            return (
                                <Card key={i} className="border-0 shadow-xl card-hover animate-slide-up h-full" style={{ animationDelay: `${i * 0.1}s` }}>
                                    <CardContent className="p-6 md:p-8 text-center flex flex-col h-full">
                                        ...
                                        <p className="text-gray-600 text-sm md:text-base mt-auto">{info.details}</p>
                                    </CardContent>
                                </Card>
                            );
                        })}
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
                            ...
                            <form className="space-y-4 md:space-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input placeholder="John" className="bg-gray-50 border-gray-200 h-12 px-4 focus:ring-blue-500" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-sm font-semibold text-gray-700">Last Name</label>
                                        <Input placeholder="Doe" className="bg-gray-50 border-gray-200 h-12 px-4 focus:ring-blue-500" />
                                    </div>
                                </div>

                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-gray-700">Email Address</label>
                                    <Input type="email" placeholder="john@example.com" className="bg-gray-50 border-gray-200 h-12 px-4 focus:ring-blue-500" />
                                </div>

                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-gray-700">Subject of Inquiry</label>
                                    <select className="w-full h-12 rounded-lg border border-gray-200 bg-gray-50 px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                                    ></textarea>
                                </div>
                        ...
                        <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div className="bg-gray-100 rounded-3xl h-[400px] md:h-[530px] flex items-center justify-center relative overflow-hidden group border-4 border-gray-50 shadow-inner">
                                ...
                                <div className="text-center relative z-10 p-8">
                                    <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl animate-bounce-slow">
                                        <MapPin className="h-10 w-10 text-blue-600" />
                                    </div>
                                    <p className="text-gray-800 font-bold text-xl md:text-2xl mb-2">Our Campus Location</p>
                                    <p className="text-gray-600 text-sm md:text-base max-w-xs mx-auto">123 Knowledge Marg, Kathmandu, Nepal</p>
                                    <Button variant="outline" className="mt-8 border-gray-300 hover:bg-white">
                                        View on Google Maps
