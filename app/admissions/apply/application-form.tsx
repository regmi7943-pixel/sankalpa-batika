...
export default function ApplicationForm({ content }: { content: any }) {
                    ...
                    <form action={handleSubmit} className="p-6 md:p-10 space-y-10">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 pb-2 border-b border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground">{content.studentInfoTitle}</h3>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 pb-2 border-b border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground">{content.guardianInfoTitle}</h3>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 pb-2 border-b border-border">
                                ...
                                <h3 className="text-xl font-bold text-foreground">{content.academicInfoTitle}</h3>
                            </div>
