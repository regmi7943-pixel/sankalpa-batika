...
import { Bell, Calendar, Clock, MapPin, ArrowRight, CalendarDays, X, Paperclip, ExternalLink } from 'lucide-react';
        ...
        <div className="min-h-screen pt-24 pb-20">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    >
                        School <span className="text-blue-600">{activeTab === 'notices' ? 'Notices' : 'Events'}</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <div className="max-w-md mx-auto mb-16">
                    <div className="flex p-1.5 bg-surface shadow-2xl rounded-2xl border border-surface-dark/5">
                        <button
                ...
                <div className="max-w-5xl mx-auto">
                    <AnimatePresence mode="wait">
                        {activeTab === 'notices' ? (
                            ...
                            >
                                <section>
                                    <SectionHeader title="Latest Notices" icon={Bell} badge={notices.length > 0 ? `${notices.length} Items` : undefined} />
                                    {notices.length > 0 ? (
                                        <div className="grid gap-10">
                                            {notices.map((notice, idx) => (
                                                <motion.div
                                                    ...
                                                    className="group cursor-pointer relative bg-surface dark:bg-slate-900/50 rounded-3xl overflow-hidden border border-slate-200/60 dark:border-slate-800/50 shadow-sm hover:shadow-2xl transition-all duration-500"
                                                >
                                                    <div className="absolute top-0 left-0 w-1.5 h-full bg-blue-400 opacity-50 group-hover:opacity-100 transition-all duration-300"></div>
                                                    <div className="p-6 md:p-8 flex flex-col md:flex-row gap-8">
                                                        <div className="flex-shrink-0 flex md:flex-col items-center justify-center gap-1 min-w-[100px]">
                                        ...
                                        <div className="p-20 text-center bg-slate-50 dark:bg-slate-900/30 rounded-[2.5rem] border-2 border-dashed border-slate-200 dark:border-slate-800">
                                            <p className="text-muted text-xl font-semibold">No notices published yet. Stay tuned!</p>
                                        </div>
                                    )}
                                </section>
                            </motion.div>
